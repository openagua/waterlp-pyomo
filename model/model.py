...
def create_model(name, template, nodes, links, types, ts_idx, params, blocks, debug=False):
    ...
    m.Storage = m.Reservoir | m.Groundwater | m.StorageTank # union
    ...
    m.ConstrainedLink = m.Conveyance | m.VirtualLink | m.VirtualLinkBidirectional | m.VirtualGroundwaterLink
    ...
    def StorageBounds_rule(m, j, t):
        ...
        elif j in m.Groundwater | m.StorageTank:
